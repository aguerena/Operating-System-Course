...
int pagefault(char *vaddress)
{
    ...
    const int conjunto_residente = 2;
    int i;
    ...
    {    
        printf("------------------- Numero de Marcos asignados del proceso %d es MENOR al conjunto residente, "
        "asignarle marco a pagina : %d\n", idproc, pag_del_proceso);
    ...
    // Es menor el numero de marcos asignados al proceso que su conjunto residente?
    else if(i == conjunto_residente)
    {

        // Determinar pagina a expulsar
        pag_a_expulsar = paginaexpulsar();
        printf("------------------- Numero de Marcos asignados del proceso %d es IGUAL al conjunto residente, "
        "asignarle marco a pagina : %d y expulsar pagina: %d\n", idproc, pag_del_proceso, pag_a_expulsar);

        if(pag_a_expulsar == -1){
            printf("------------------- ERROR FATAL, No encontro pagina a expulsar\n");
            return -1;    
        }
